...
| --- | --- | --- | --- |
| 1.1 | El proceso elimina toda subjetividad porque es enteramente mecánico. | Independencia subjetiva absoluta | Examina si una secuencia puramente algorítmica puede prescindir de toda agencia subjetiva en la selección de axiomas. ¿Aparecen sesgos en el diseño del lenguaje, los operadores o el procedimiento mismo? |
| 1.2 | Solo las tautologías pueden ser axiomas bajo este método. | Reducción axiomática al tautologicismo | Se explora si existen sistemas formales cuyos axiomas útiles no sean proposiciones tautológicas clásicas y si este método no los puede captar. |
| 1.3 | El método garantiza validez universal de cualquier axioma aceptado. | Universalidad lógica de los axiomas resultantes | ¿Se puede hablar de universalidad fuera del dominio proposicional-exhaustivo o surgen limitaciones estructurales? |

## evaluacion_global

- **estado**: indefinido
- **criterio**: El método garantiza objetividad formal respecto al cálculo booleano, pero introduce dependencias fuera del procedimiento (definición del lenguaje, elección de operadores, omisión de posibles axiomas no-tautológicos); queda limitado por la expresividad del sistema formal subyacente.

## observaciones_deductivas

| origen | conclusion | notas |
| --- | --- | --- |
| Definición de tautología | Solo fórmulas tautológicas pueden quedar incluidas como axiomas bajo este procedimiento. | Excluye axiomas contingentes, probabilistas o dependientes del contexto fuera de la lógica proposicional clásica. |
| Determinismo del cálculo de tablas de verdad | Dada la totalidad de asignaciones posibles, la verificación no puede depender de la voluntad o preferencia del evaluador. | Restan márgenes de subjetividad en el diseño inicial del sistema formal. |

## contraejemplos

| afirmacion_refutada | descripcion | grado_de_refutacion | notas |
| --- | --- | --- | --- |
| La selección de axiomas depende solo del cálculo mecánico y es totalmente independiente de subjetividad. | La elección de operadores lógicos, el lenguaje formal, y la definición de lo que constituye un axioma quedan fijadas antes de la mecanización. | parcial | Si el marco es limitado, la 'objetividad' queda enmarcada por decisiones iniciales, posiblemente subjetivas o históricas. |
| Toda teoría formal requiere solo tautologías como axiomas. | En aritmética, la ley de Peano sobre el sucesor no es una tautología en el sentido clásico formal, pero es axiomática; lo mismo ocurre en teoría de conjuntos (axioma de elección). | total | Parte de la axiomática matemática no corresponde a tautologías lógicas, sino a postulados fundacionales necesarios para la estructura teórica deseada. |

## observaciones_inductivas

| patron_observado | inferencia | grado_de_confianza | notas |
| --- | --- | --- | --- |
| Diferentes matemáticos y lógicos escogen sistemas axiomáticos iniciales distintos según intereses y contextos históricos. | Todo procedimiento mecánico requiere inicialmente un marco, que puede ser fijado subjetiva o culturalmente. | alto | La objetividad algorítmica inicia solo después de una serie de elecciones previas que suelen escapar al cálculo formal. |

## conclusion_preconceptual

El robot solo puede probar caminos posibles en el mapa que tú le diste. Aunque él nunca opina ni se cansa, tú elegiste el tipo de laberinto y las reglas del juego.

## teoria_o_intuicion_emergente

La mecanización absoluta de la selección axiomática garantiza objetividad interna al procedimiento pero no a la construcción inicial del marco lingüístico-formal; toda objetividad de segundo orden está anclada a elecciones meta-formales previas, necesariamente subjetivas o contingentes.
